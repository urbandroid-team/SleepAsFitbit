...
async function getConnectionURL(hostID) {
    const response = await baseAPI_1.apiFetch(`1/user/-/developer-relay/hosts/${hostID}`, { method: 'POST' }).then(fetchUtil_1.assertOK).then(fetchUtil_1.assertContentType('text/uri-list'));

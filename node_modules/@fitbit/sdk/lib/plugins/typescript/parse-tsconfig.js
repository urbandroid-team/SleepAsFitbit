...
function parseTsConfig(tsConfig, tsconfigOverride, onDiagnostics) {
    const fileName = typescript_1.default.findConfigFile(process.cwd(), typescript_1.default.sys.fileExists, tsConfig);

...
exports.isProjectBuildError = isProjectBuildError;
...
function convertPluginErrorToDiagnostic(error) {
    const diagnostic = {
        ...
        if (detailKeys.length) {
            const detailsText = detailKeys.map((key) => {
                ...
                if (typeof value === 'string' && value.includes('\n')) {
                    return `    ${key}:\n${indent_string_1.default(value, 6)}\n`;
                }
                return `    ${key}: ${value}\n`;
            }).join('');
...
exports.convertPluginErrorToDiagnostic = convertPluginErrorToDiagnostic;

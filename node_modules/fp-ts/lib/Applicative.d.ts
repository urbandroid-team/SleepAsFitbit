...
export interface ApplicativeComposition12<F extends URIS, G extends URIS2> extends FunctorComposition12<F, G> {
    ...
    readonly ap: <L, A, B>(fgab: Type<F, Type2<G, L, (a: A) => B>>, fga: Type<F, Type2<G, L, A>>) => Type<F, Type2<G, L, B>>;
}
...
export interface ApplicativeComposition21<F extends URIS2, G extends URIS> extends FunctorComposition21<F, G> {
    ...
    readonly ap: <L, A, B>(fgab: Type2<F, L, Type<G, (a: A) => B>>, fga: Type2<F, L, Type<G, A>>) => Type2<F, L, Type<G, B>>;
}
...
export interface ApplicativeComposition22C<F extends URIS2, G extends URIS2, M> extends FunctorComposition22C<F, G, M> {
    ...
    readonly ap: <L, A, B>(fgab: Type2<F, L, Type2<G, M, (a: A) => B>>, fga: Type2<F, L, Type2<G, M, A>>) => Type2<F, L, Type2<G, M, B>>;
}
export interface ApplicativeComposition3C1<F extends URIS3, G extends URIS, U, L> extends FunctorComposition3C1<F, G, U, L> {
    readonly of: <A>(a: A) => Type3<F, U, L, Type<G, A>>;
    readonly ap: <A, B>(fgab: Type3<F, U, L, Type<G, (a: A) => B>>, fga: Type3<F, U, L, Type<G, A>>) => Type3<F, U, L, Type<G, B>>;
}
...
export declare function getApplicativeComposition<F extends URIS2, G extends URIS2, L>(F: Applicative2<F>, G: Applicative2C<G, L>): ApplicativeComposition22C<F, G, L>;

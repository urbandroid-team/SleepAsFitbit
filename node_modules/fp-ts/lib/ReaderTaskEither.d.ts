 ...
 * @since 1.6.0
 */
export declare const fromPredicate: <E, L, A>(predicate: Predicate<A>, whenFalse: (a: A) => L) => (a: A) => ReaderTaskEither<E, L, A>;
/**
 * @function
 * @since 1.6.0
 */
export declare const tryCatch: <E, L, A>(f: (e: E) => Promise<A>, onrejected: (reason: {}) => L) => ReaderTaskEither<E, L, A>;
/**
 * @instance
 * @since 1.6.0
 */

...
export declare function comprehension<A, R>(input: [Array<A>], f: (a: A) => boolean, g: (a: A) => R): Array<R>;
export declare const array: Monad1<URI> & Foldable2v1<URI> & Unfoldable1<URI> & Traversable2v1<URI> & Alternative1<URI> & Plus1<URI> & Extend1<URI> & Compactable1<URI> & Filterable1<URI> & Witherable1<URI>;
